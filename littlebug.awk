...

{
  ...
  line = gensub(/&/, "＆ａｍｐ", "g", line);
  line = gensub(/＆ａｍｐ#047;/, "＆＃０４７", "g", line);
  line = gensub(/\//, "＆＃０４７", "g", line);
  line = gensub(/＆ａｍｐ#092;/, "＆＃０９２", "g", line);
  line = gensub(/\\/, "＆＃０９２", "g", line);
  # line = gensub(/>/＆ｇｔ/g; \
  # line = gensub(/\(\&\|＆ａｍｐ\)gt;/＆ｇｔ/g; \
  # line = gensub(/</＆ｌｔ/g; \
  # line = gensub(/\(\&\|＆ａｍｐ\)lt;/＆ｌｔ/g; \
  # line = gensub(/'\''/＆＃３９/g; \
  # line = gensub(/\(\&\|＆ａｍｐ\)#39;/＆＃３９/g; \
  # line = gensub(/\"/＆ｑｕｏｔ/g; \
  # line = gensub(/\(\&\|＆ａｍｐ\)#quot;/＆ｑｕｏｔ/g" \
  #   "${line = gensub(le}"
